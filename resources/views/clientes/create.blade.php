    ...
    <form action="{{ isset($cliente) ? route('clientes.update', $cliente->id_catalogo_cliente) : route('clientes.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="tipo_cliente" name="tipo_cliente" required>
                ...
                <option value="2" {{ (isset($cliente) && $cliente->tipo_cliente == 2) ? 'selected' : '' }}>Créditos Fiscales</option>
        ...
        <div class="mb-3" id="documento-group">
            <label for="dui_nit" class="form-label">Documento (DUI/NIT)</label>
